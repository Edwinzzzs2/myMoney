...
export function ExpenseRow({
  ...
  return (
    <article
      ...
      onClick={selectable ? () => onToggleSelected?.(expense) : undefined}
      onKeyDown={
        selectable
          ? (event) => {
      ...
      className={cn(
        ...
        selectable && 'cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-300/70 dark:focus:ring-emerald-300/35',
